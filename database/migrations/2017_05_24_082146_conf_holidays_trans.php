    ...
    public function up()
    {
        Schema::table('conf_holidays_trans', function(Blueprint $table) {
            ...
            $sql = 'CREATE TABLE `conf_holidays_trans` (
              ...
              CONSTRAINT `conf_holidays_trans_ibfk_1` FOREIGN KEY (`holidays_id`) REFERENCES `conf_holidays` (`id`),
              CONSTRAINT `conf_holidays_trans_ibfk_2` FOREIGN KEY (`languages_id`) REFERENCES `conf_languages` (`id`)
