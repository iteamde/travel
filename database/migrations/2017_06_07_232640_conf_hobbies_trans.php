    ...
    public function up()
    {
        Schema::table('conf_hobbies_trans', function(Blueprint $table) {
            ...
            $sql = 'CREATE TABLE `conf_hobbies_trans` (
              ...
              CONSTRAINT `conf_hobbies_trans_ibfk_1` FOREIGN KEY (`hobbies_id`) REFERENCES `conf_hobbies` (`id`),
              CONSTRAINT `conf_hobbies_trans_ibfk_2` FOREIGN KEY (`languages_id`) REFERENCES `conf_languages` (`id`)
