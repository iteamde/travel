...
class ActivitiesTransTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('activities_trans', function(Blueprint $table) {
            ...
            CONSTRAINT `activities_trans_ibfk_1` FOREIGN KEY (`activities_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE,
            CONSTRAINT `activities_trans_ibfk_2` FOREIGN KEY (`languages_id`) REFERENCES `conf_languages` (`id`) ON DELETE CASCADE
