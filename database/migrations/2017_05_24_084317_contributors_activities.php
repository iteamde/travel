...
class ContributorsActivities extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('contributors_activities', function(Blueprint $table) {
            $sql = 'DROP TABLE IF EXISTS `contributors_activities`;';
            DB::connection()->getPdo()->exec($sql);
            
            $sql = 'CREATE TABLE `contributors_activities` (
