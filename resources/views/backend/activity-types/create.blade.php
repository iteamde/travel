...
@section ('title', 'Activity Types Manager' . ' | ' . 'Create Activity Type')
...
@section('page-header')
    ...
    <h1>
        ...
        <small>Create Activity Type</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::open([
            'id'     => 'activity_types_form',
            'route'  => 'admin.activities.activitytypes.store',
