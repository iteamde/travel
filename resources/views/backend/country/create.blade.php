            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    @foreach($languages as $language)
                        <div id="{{ $language->code }}" class="tab-pane fade in {{ ($languages[0]->id == $language->id)? 'active':'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('description_'.$language->id, null, ['class' => 'form-control description_input description', 'placeholder' => 'Quick Facts']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: Description -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('cost_of_living_'.$language->id, null, ['class' => 'form-control', 'maxlength' => '191', 'placeholder' => 'Cost of Living Index']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: cost_of_living -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('geo_stats_'.$language->id, null, ['class' => 'form-control', 'maxlength' => '191', 'placeholder' => 'Crime Rate Index']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: geo_stats -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('demographics_'.$language->id, null, ['class' => 'form-control', 'maxlength' => '191','placeholder' => 'Quality of Life Index']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: demographics -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('economy_'.$language->id, null, ['class' => 'form-control', 'maxlength' => '191', 'placeholder' => 'Restrictions']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: economy -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('suitable_for_'.$language->id, null, ['class' => 'form-control', 'maxlength' => '191', 'placeholder' => 'Hijab Allowed?']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: suitable_for -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('cities_id[]', $cities , null,['class' => 'select2Class form-control' , 'multiple' => 'multiple']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- Capitals: End -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('additional_languages_spoken_id[]', $languages_spoken , null,['class' => 'select2Class form-control' , 'multiple' => 'multiple']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
