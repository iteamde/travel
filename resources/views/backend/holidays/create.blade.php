...
@section ('title', 'Holidays Manager' . ' | ' . 'Create Holidays')
...
@section('content')
    {{ Form::open([
            'id'     => 'holidays_form',
            'route'  => 'admin.holidays.holidays.store',
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Create Holidays</h3>
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.holidays.holidays.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
