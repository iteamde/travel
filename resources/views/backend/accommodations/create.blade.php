...
@section ('title', 'Accommodations Manager' . ' | ' . 'Create Accommodation')
...
@section('page-header')
    ...
    <h1>
        ...
        <small>Create Accommodation</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::open([
            'id'     => 'accommodations_form',
            'route'  => 'admin.accommodations.accommodations.store',
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Create Accommodation</h3>
