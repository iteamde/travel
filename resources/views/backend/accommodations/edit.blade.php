...
@section ('title', 'Accommodations Manager' . ' | ' . 'Edit Accommodation')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Accommodations Management
        <small>Edit Accommodation</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($accommodations, [
            'id'     => 'accommodations_update_form',
            'route'  => ['admin.accommodations.accommodations.update', $accommodationsid],
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.accommodations.accommodations.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
