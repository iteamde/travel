...
@section ('title', 'Hobbies Manager' . ' | ' . 'Edit Hobbies')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Hobbies Management
        <small>Edit Hobbies</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($hobbies, [
            'id'     => 'hobbies_update_form',
            'route'  => ['admin.hobbies.hobbies.update', $hobbiesid],
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Edit Hobbies</h3>
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.hobbies.hobbies.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
