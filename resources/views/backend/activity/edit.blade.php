...
@section ('title', 'Activities Manager' . ' | ' . 'Edit Activity')
...
@section('content')
    {{ Form::model($activity, [
            ...
            'route'  => ['admin.activities.activity.update', $activityid],
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('types_id', $activity_types , $data['types_id'] ,['class' => 'select2Class form-control']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- Activity Types: End -->
                    <!-- Countries: Start -->
