...
@section ('title', 'Pages Categories Manager' . ' | ' . 'Create Pages Categories')
...
@section('page-header')
    ...
    <h1>
        ...
        <small>Create Pages Categories</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::open([
            'id'     => 'pages_categories_form',
            'route'  => 'admin.pages.pages_categories.store',
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Create Pages Categories</h3>
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('title', null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Title']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- End: Title -->
                @endif
