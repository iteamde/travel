...
@section ('title', 'Pages Categories Manager' . ' | ' . 'Edit Pages Categories')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Pages Categories Management
        <small>Edit Page Category</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($pages_categories, [
            'id'     => 'pages_categories_update_form',
            'route'  => ['admin.pages.pages_categories.update', $pages_categories_id],
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Edit Page Category</h3>
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('title', $data['title'] , ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Title']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- End: Title -->
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.pages.pages_categories.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
