...
@section ('title', 'Cultures Manager' . ' | ' . 'Edit Cultures')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Cultures Management
        <small>Edit Cultures</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($cultures, [
            'id'     => 'cultures_update_form',
            'route'  => ['admin.cultures.cultures.update', $culturesid],
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Edit Cultures</h3>
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.cultures.cultures.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
