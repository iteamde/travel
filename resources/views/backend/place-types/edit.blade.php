...
@section ('title', 'Place Types Manager' . ' | ' . 'Edit Place Type')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Place Types Management
        <small>Edit Place Type</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($placetype, [
            'id'     => 'place_types_update_form',
            'route'  => ['admin.location.placetypes.update', $placetypeid],
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Create Place Type</h3>
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.location.placetypes.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
