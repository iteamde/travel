...
@section('content')
    {{ Form::model($restaurant, [
            ...
            'route'  => ['admin.restaurants.restaurants.update', $restaurantid],
                    ...
                    @foreach($languages as $language)
                        <div id="{{ $language->code }}" class="tab-pane fade in {{ ($languages[0]->id == $language->id)? 'active':'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('num_activities_'.$language->id, $data['num_activities_'.$language->id], ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Num Activities']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: num_activities -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('popularity_'.$language->id, $data['popularity_'.$language->id] , ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Popularity']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: popularity -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('conditions_'.$language->id, $data['conditions_'.$language->id], ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Conditions']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: conditions -->
