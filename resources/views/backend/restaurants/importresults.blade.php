...
<div class="box box-success">
    {{ Form::open([
            'id'    => 'User_form',
            'route' => 'admin.restaurants.restaurants.savesearch',
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="pull-left">
                {{ link_to_route('admin.restaurants.restaurants.import', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
            </div><!--pull-left-->
            ...
            <div class="pull-right">
                ...
                {{ Form::submit('Save Restaurants', ['class' => 'btn btn-success btn-xs submit_button']) }}
            </div><!--pull-right-->
