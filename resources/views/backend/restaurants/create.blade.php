...
@section ('title', 'Restaurants Manager' . ' | ' . 'Create Restaurant')
...
@section('content')
    {{ Form::open([
            'id'     => 'restaurants_form',
            'route'  => 'admin.restaurants.restaurants.store',
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    @foreach($languages as $language)
                        <div id="{{ $language->code }}" class="tab-pane fade in {{ ($languages[0]->id == $language->id)? 'active':'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('working_days_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Working Days']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: working_days -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('working_times_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Working Times']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: working_times -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('how_to_go_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'How To Go']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: how_to_go -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('when_to_go_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'When To Go']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: when_to_go -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('num_activities_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Num Activities']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: num_activities -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('popularity_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Popularity']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: popularity -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::textarea('conditions_'.$language->id, null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Conditions']) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
                            <!-- End: conditions -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('countries_id', [] , null,['class' => 'select2Class form-control','id' => 'country-dropdown-custom']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- Country: End -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('places_id', [] , null,['class' => 'select2Class form-control','id' => 'place-dropdown-custom']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- Place: End -->
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.restaurants.restaurants.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
