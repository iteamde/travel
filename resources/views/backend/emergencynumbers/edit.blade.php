...
@section ('title', 'Emergency Numbers Manager' . ' | ' . 'Edit Emergency Numbers')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Emergency Numbers Management
        <small>Edit Emergency Numbers</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($emergencynumbers, [
            'id'     => 'emergencynumbers_update_form',
            'route'  => ['admin.emergencynumbers.emergencynumbers.update', $emergencynumbersid],
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Edit Emergency Numbers</h3>
