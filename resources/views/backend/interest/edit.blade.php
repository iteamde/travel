...
@section ('title', 'Interests Manager' . ' | ' . 'Edit Interest')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Interests Management
        <small>Edit Interest</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($interest, [
            'id'     => 'interest_update_form',
            'route'  => ['admin.interest.interest.update', $interestid],
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.interest.interest.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
