...
@section ('title', 'Hotels Manager' . ' | ' . 'Import Hotels')
...
{{ Form::open([
            'id'    => 'User_form',
            'route' => 'admin.hotels.hotels.search',
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Import Hotels</h3>
...
<script>
    ...
    function draw_markers(Map) {
        ...
        $.ajax({
            type: "GET",
            url: "{{route('admin.hotels.hotels.searchhistory')}}",
