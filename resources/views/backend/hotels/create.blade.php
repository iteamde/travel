            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('city_id', [] , null,['class' => 'select2Class form-control','id' => 'city-dropdown-custom']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- City: End -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('place_id', [] , null,['class' => 'select2Class form-control','id' => 'place-dropdown-custom']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- Place : End -->
