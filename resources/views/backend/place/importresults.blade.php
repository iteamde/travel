...
<div class="box box-success">
    {{ Form::open([
            'id'    => 'User_form',
            'route' => 'admin.location.place.savesearch',
                ...
                <tbody>
                    ...
                    <tr @if(in_array($r->place_id, $provider_ids)) style="background-color:red" @endif>
                        ...
                        <th>
                            ...
                            <input type="hidden" name="place[{{$i}}][types]" value='{{$r->types}}' />
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="pull-left">
                {{ link_to_route('admin.location.place.import', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
            </div><!--pull-left-->
