...
@section ('title', 'Levels Manager' . ' | ' . 'Edit Levels')

@section('page-header')
    <h1>
        <!-- {{ trans('labels.backend.access.users.management') }} -->
        Levels Management
        <small>Edit Levels</small>
    </h1>
@endsection
...
@section('content')
    {{ Form::model($levels, [
            'id'     => 'levels_update_form',
            'route'  => ['admin.levels.levels.update', $levelsid],
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.levels.levels.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
