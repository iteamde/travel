...
@section('content')
    {{ Form::open([
            'id'     => 'activitymedia_form',
            'route'  => 'admin.activitymedia.activitymedia.store',
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('url', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Url']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- End: URL -->
                @endif
