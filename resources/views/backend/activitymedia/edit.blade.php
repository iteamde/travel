...
@section('content')
    {{ Form::model($media, [
            'id'     => 'activitymedia_update_form',
            'route'  => ['admin.activitymedia.activitymedia.update', $mediaid],
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('url', $data['url'], ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Url']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- End: URL -->
                @endif
        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="pull-left">
                    {{ link_to_route('admin.activitymedia.activitymedia.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
                </div><!--pull-left-->
