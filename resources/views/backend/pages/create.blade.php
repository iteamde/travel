...
@section ('title', 'Pages Manager' . ' | ' . 'Create Pages')
            ...
            <div class="box-body">
                ...
                @if(!empty($languages))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('url', null, ['class' => 'form-control required', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Title']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- End: Url -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {{ Form::select('admins_id[]', $admins , null,['class' => 'select2Class form-control' , 'multiple' => 'multiple']) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    <!-- Admins : End -->
