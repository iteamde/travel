...
trait HolidaysAttribute
{
    ...
    {
        return '<a href="'.route('admin.holidays.holidays.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('admin.holidays.holidays.show', $this).'" class="btn btn-xs btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.view').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('admin.holidays.holidays.delete', $this).'"
             data-method="delete"
