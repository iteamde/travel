...
trait MediaAttribute
{
    ...
    {
        return '<a href="'.route('admin.activitymedia.activitymedia.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('admin.activitymedia.activitymedia.show', $this).'" class="btn btn-xs btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.view').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('admin.activitymedia.activitymedia.delete', $this).'"
             data-method="delete"
