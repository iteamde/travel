...
use App\Models\Religion\Traits\Relationship\ReligionTransRelationship;

class ReligionTranslations extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'conf_religions_trans';

    public $timestamps = false;

    use ReligionTransRelationship;
